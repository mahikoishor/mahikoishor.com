...
export const SOCIAL_LINKS = [
  {
    icon: FaLinkedin,
    href: "https://www.linkedin.com/in/ammmahikaishar",
  },
  {
    icon: FaGithub,
    href: "https://www.github.com/ammmdmahikaishar",
  },
  {
    icon: FaFacebook,
    href: "https://www.facebook.com/ammmdmahikaishar",
  },
];
...
export const CONTACT_TALKS = [
  {
    icon: BiMailSend,
    name: "Email",
    short: "ammmahikaishar",
    href: "mailto:ammmahikaishar@gmail.com",
  },
  {
    icon: FaWhatsapp,
    name: "Whatsapp",
    short: "+880-1340-579313",
    href: "https://api.whatsapp.com/send?phone=8801340579313&text=Hello, Let's do something together!",
  },
  {
    icon: BsMessenger,
    name: "Messanger",
    short: "ammmahikaishar",
    href: "https://m.me/ammmahikaishar",
  },
];
