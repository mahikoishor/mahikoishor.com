      ...
      <div className={styles.container + " " + "container"} >
        <div className={styles.text}>
          ...
          <div className={styles.buttonContainer}>
            <motion.a className="button buttonOutline" href="/ammmahikaishar-cv.pdf" {...fadeIn({ mode: "view", delay: 1.5 })}>
              Download CV
            </motion.a>
        ...
        <motion.div className={styles.imgContainer} {...fadeIn({ mode: "view", direction: "bottom", delay: 2 })}>
          <Image className={styles.img} src="/perfil.png" width={200} height={300} alt="ammmahikaishar" />
        </motion.div>
